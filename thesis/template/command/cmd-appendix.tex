...
{%
  ...
  \renewcommand{\thefigure}{\GetAppendixChapterNumberingFormatString.\arabic{figure}}
  \renewcommand{\thetable}{\GetAppendixChapterNumberingFormatString.\arabic{table}}
  \renewcommand{\theequation}{\GetAppendixChapterNumberingFormatString.\arabic{equation}} % 公式編號也一併修正
