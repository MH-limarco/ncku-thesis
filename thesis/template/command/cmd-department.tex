...
% Use the list from:
%   https://www.ncku.edu.tw/p/412-1000-182.php (Version: 2025-03-03 21:57)
...
% 企業管理學系 Master of Business Administration
% https://ba.ncku.edu.tw/p/412-1177-24065.php?Lang=en
\newcommand{\SetDeptMBA}
{
  \SetDeptName{企業管理學系}{MBA}{Master of Business Administration}
  \SetCollegeManagement
} % End of \newcommand{}
...
\newcommand{\SetDeptIntelligentComputing}
{
  \SetDeptName{智慧運算碩士學位學程}{MSIC}{MS Degree in Intelligent Computing}
  \SetCollegeMiinWuComputing
} % End of \newcommand{}
